...
if (isset($_POST['place_order'])) {
    ...
    foreach ($_SESSION['cart'] as $item) {
        ...
        $query = "INSERT INTO buynow(product_id, p_name, price, qty, fullname, province, city, area, colony, house, address, image)
     VALUES ('$pid','$pname','$price','$qty','$fullname','$province','$city','$area','$colony','$house','$address','$image')";
                ...
                <div class="order-summary">
                    ...
                    <?php foreach ($_SESSION['cart'] as $item): ?>
                        <div class="d-flex align-items-center mb-3">
                            <img src="../dashboard/upload/<?php echo $item['image']; ?>" width="60" height="60" class="rounded me-3" alt="Product">
                            <div>
